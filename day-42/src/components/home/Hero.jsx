                ...
                <div className="grid lg:grid-cols-2 items-center gap-x-12 gap-y-16">
                    <div className="max-lg:text-center">
                        ...
                        <div className="mt-12 flex flex-wrap max-lg:justify-center gap-4">
                            ...
                            <Link to="/contact" className="px-6 py-3 text-base font-semibold text-violet-700 border border-violet-600 rounded-full hover:bg-gray-100 transition-all focus:outline-none">Contact Now</Link>
                        </div>
                    </div>
