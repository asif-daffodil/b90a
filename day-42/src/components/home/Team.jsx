        ...
        <div className="p-4">
            <div className="max-w-7xl max-lg:max-w-3xl mx-auto">
                <div className="text-center">
                    <h2 className="text-slate-900 text-3xl md:text-4xl font-bold">Meet our team</h2>
                </div>
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 max-sm:justify-center mt-12 max-md:max-w-xl max-sm:max-w-xs mx-auto">
                    <div className="bg-gray-800 p-3 border rounded-lg">
                        ...
                        <div className="text-center mt-4 mb-1">
                            ...
                            <p className="text-[13px] mt-1 text-slate-300 font-medium">John Doe</p>
                        </div>
                    </div>
                    <div className="bg-gray-800 p-3 border rounded-lg">
                        <div className="bg-gray-50 aspect-square rounded-lg overflow-hidden">
                        ...
                        <div className="text-center mt-4 mb-1">
                            ...
                            <p className="text-[13px] mt-1 text-slate-300 font-medium">Mark Adair</p>
                        </div>
                    </div>
                    <div className="bg-gray-800 p-3 border rounded-lg">
                        <div className="bg-gray-50 aspect-square rounded-lg overflow-hidden">
                        ...
                        <div className="text-center mt-4 mb-1">
                            ...
                            <p className="text-[13px] mt-1 text-slate-300 font-medium">Simon Konecki</p>
                        </div>
                    </div>
                    <div className="bg-gray-800 p-3 border rounded-lg">
                        <div className="bg-gray-50 aspect-square rounded-lg overflow-hidden">
                        ...
                        <div className="text-center mt-4 mb-1">
                            <h4 className="text-[15px] font-medium text-white">Web Designer</h4>
                            <p className="text-[13px] mt-1 text-slate-300 font-medium">Eleanor</p>
                        </div>
                    </div>
                    <div className="bg-gray-800 p-3 border rounded-lg">
                        <div className="bg-gray-50 aspect-square rounded-lg overflow-hidden">
                        ...
                        <div className="text-center mt-4 mb-1">
                            <h4 className="text-[15px] font-medium text-white">Software Engineer</h4>
                            <p className="text-[13px] mt-1 text-slate-300 font-medium">Alen</p>
                        </div>
                    </div>
                    <div className="bg-gray-800 p-3 border rounded-lg">
                        <div className="bg-gray-50 aspect-square rounded-lg overflow-hidden">
                        ...
                        <div className="text-center mt-4 mb-1">
                            ...
                            <p className="text-[13px] mt-1 text-slate-300 font-medium">Sophia</p>
                        </div>
                    </div>
                </div>
            </div>
