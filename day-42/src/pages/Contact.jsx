        ...
        <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white p-4">
            ...
            <div className="grid lg:grid-cols-5 items-center p-2 [box-shadow:0_2px_10px_-3px_rgba(115,120,131,0.6)] rounded-lg mt-12">
                <div className="lg:col-span-2 bg-indigo-800 rounded-lg p-6 h-full max-lg:order-1 relative overflow-hidden max-lg:mt-12">
                    ...
                    <div className="mt-16 relative z-50">
                        <ul className="space-y-8">
                            <li className="flex items-center text-slate-200 hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="16px" height="16px" viewBox="0 0 479.058 479.058">
                        ...
                        <ul className="flex flex-wrap gap-y-4 gap-x-5 mt-16">
                            <li className="bg-slate-200 hover:bg-white h-9 w-9 rounded-full flex items-center justify-center shrink-0">
                                <a href="javascript:void(0)">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4.5 h-4.5 fill-slate-900" viewBox="0 0 24 24">
                            ...
                            <li className="bg-slate-200 hover:bg-white h-9 w-9 rounded-full flex items-center justify-center shrink-0">
                                <a href="javascript:void(0)">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4.5 h-4.5 fill-slate-900" viewBox="0 0 511 512">
                    ...
                    <div className="absolute -bottom-24 -right-24 w-60 h-60 rounded-full bg-teal-500" />
                </div>
                <div className="px-4 sm:px-8 py-4 lg:col-span-3">
                    <form>
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="relative flex items-center">
                                <input type="text" placeholder="First Name" className="px-2 py-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none" />
                            ...
                            <div className="relative flex items-center">
                                <input type="text" placeholder="Last Name" className="px-2 py-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-4 h-4 absolute right-2" viewBox="0 0 24 24">
                                    <circle cx={10} cy={7} r={6} data-original="#000000" />
                                    <path d="M14 15H6a5 5 0 0 0-5 5 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 5 5 0 0 0-5-5zm8-4h-2.59l.3-.29a1 1 0 0 0-1.42-1.42l-2 2a1 1 0 0 0 0 1.42l2 2a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42l-.3-.29H22a1 1 0 0 0 0-2z" data-original="#000000" />
                                </svg>
                            ...
                            <div className="relative flex items-center">
                                <input type="number" placeholder="Phone No." className="px-2 py-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none" />
                            ...
                            <div className="relative flex items-center">
                                <input type="email" placeholder="Email" className="px-2 py-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none" />
                            ...
                            <div className="relative flex items-center col-span-full">
                                <textarea placeholder="Write Message" className="px-2 pt-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none" defaultValue={""} />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-4 h-4 absolute right-2" viewBox="0 0 682.667 682.667">
                                    <defs>
                                        <clipPath id="a" clipPathUnits="userSpaceOnUse">
                                            <path d="M0 512h512V0H0Z" data-original="#000000" />
                                ...
                                <div className="flex flex-wrap gap-6 mt-4">
                                    <div className="flex items-center">
                                        ...
                                        <label htmlFor="radio1" className="relative p-0.5 flex items-center justify-center shrink-0 peer-checked:before:hidden before:block before:absolute before:w-full before:h-full before:bg-white w-5 h-5 cursor-pointer border-2 border-[#011c2b] rounded-full overflow-hidden">
                                            <span className="border-4 border-[#011c2b] rounded-full w-full h-full" />
                                        </label>
                        ...
                        <button type="button" className="mt-12 flex items-center justify-center text-sm font-medium lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide cursor-pointer text-white bg-indigo-600 hover:bg-indigo-700">
